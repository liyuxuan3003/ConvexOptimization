...
当爆炸的恒星的第一层膨涨外壳穿过那个橙黄色行星时，它立刻被汽化了。其实在这整个爆炸的壮丽场景中根本就看不到它，同那膨涨的恒星外壳相比，它只是一粒微不足道的灰尘，其大小甚至不能成为那几层缕花玻璃球上的一个小点。\footnote{123}
...
\cref{chap:章节文本,chap:数学公式}

\cref{chap:章节文本,chap:数学公式,chap:表格图像}

\cref{chap:章节文本,chap:数学公式,chap:表格图像,ap:附录测试}

\cref{chap:章节文本,chap:数学公式,chap:表格图像,subsec:Align,sec:gamma}

\section[Γ 函数的短标题]{$\Gamma$函数;gamma}
...
\section{下划线}
\uwave{Hello world. Hello world. Hello world. Hello world. Hello world. Hello world. Hello world. Hello world. Hello world. Hello world. Hello world. Hello world. Hello world. Hello world. Hello world. Hello world. Hello world. Hello world. Hello world. }

\uwave{这是一个很长的中文，这是一个很长的中文，这是一个很长的中文，这是一个很长的中文，这是一个很长的中文，这是一个很长的中文，还包含$x^2$这样的数学公式。}

ulem测试

\uline{傅里叶变化Alpha Beta Gamma}

\uuline{傅里叶变换Alpha Beta Gamma}

\uwave{傅里叶变换Alpha Beta Gamma}

\sout{傅里叶变换Alpha Beta Gamma}

\xout{傅里叶变换Alpha Beta Gamma}

\dotuline{傅里叶变换Alpha Beta Gamma}

\dashuline{傅里叶变换Alpha Beta Gamma}

xeCJKfntef

\CJKunderline{傅里叶变换Alpha Beta Gamma}

\CJKunderdblline{傅里叶变换Alpha Beta Gamma}

\CJKunderwave{傅里叶变换Alpha Beta Gamma}

\CJKsout{傅里叶变换Alpha Beta Gamma}

\CJKxout{傅里叶变换Alpha Beta Gamma}

\CJKunderdot{傅里叶变换Alpha Beta Gamma}
...
\url{https://www.bilibili.com/video/BV1Vd4y1e7pj/?spm_id_from=333.1387.homepage.video_card.click&vd_source=fa5f84e6b40f4e54aefc259739f0beec}

\section{颜色}
{\color{blue} 文字base}

{\color{Salmon} 文字dvipsnames}

{\color{LightCoral} 文字svgnames}

{\color{DarkOrchid1} 文字x11names}

{\color{red!50!white} 颜色混合}

{\color[rgb]{0.1,0.3,0.5} 颜色指定}

\textcolor{LightCoral}{文本的颜色}可以这样指定。

\section{带圈数字和罗马数字}
\circnum{1}、\circnum{1}、\circnum{2}、\circnum{3}、\circnum{4}、\circnum{5}、\circnum{6}、\circnum{7}、\circnum{8}、\circnum{9}、\circnum{10}

\circnumdark{1}、\circnumdark{1}、\circnumdark{2}、\circnumdark{3}、\circnumdark{4}、\circnumdark{5}、\circnumdark{6}、\circnumdark{7}、\circnumdark{8}、\circnumdark{9}、\circnumdark{10}

\romannum{1}、\romannum{1}、\romannum{2}、\romannum{3}、\romannum{4}、\romannum{5}、\romannum{6}、\romannum{7}、\romannum{8}、\romannum{9}、\romannum{10}
...
\section{参考文献测试}
引用结果是\cite{2021-Bozorg-00245GHzLNTA28nm,2021-Liu-0061mm2111GHzNoiseCanceling}